...
use \examples\statemachines\PwrCall\TechnicalProblemState;
...
//###END_CUSTOMCODE1
class TechnicalProblemTest extends \PHPUnit_Framework_TestCase {
    /**
     * @var PwrCall
     */
    private $pwrcall;
    ...
    protected function setUp() {
        $this->pwrcall = new PwrCall(new TechnicalProblemState);
    }
//>>>> don't change the CUSTOM CODE comments, if you do generation will overwrite your code >>>>
//###START_CUSTOMCODE2
...
//###END_CUSTOMCODE2
     ...
     */
    public function testIsTechnicalProblemState() {
     ...
     * @covers \examples\statemachines\PwrCall\TechnicalProblemState::cancel
     ...
     * @covers \examples\statemachines\PwrCall\TechnicalProblemState::restartAfterTechFailure
