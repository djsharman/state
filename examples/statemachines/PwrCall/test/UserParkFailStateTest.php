...
use \examples\statemachines\PwrCall\UserParkFailState;
...
//###END_CUSTOMCODE1
class UserParkFailTest extends \PHPUnit_Framework_TestCase {
    /**
     * @var PwrCall
     */
    private $pwrcall;
    ...
    protected function setUp() {
        $this->pwrcall = new PwrCall(new UserParkFailState);
    }
//>>>> don't change the CUSTOM CODE comments, if you do generation will overwrite your code >>>>
//###START_CUSTOMCODE2
...
//###END_CUSTOMCODE2
     ...
     * @covers \examples\statemachines\PwrCall\UserParkFailState::cancel
     ...
     * @covers \examples\statemachines\PwrCall\UserParkFailState::restartAfterTechFailure
