...
//###END_CUSTOMCODE1
class WaitForUserRegTest extends \PHPUnit_Framework_TestCase {
    /**
     * @var PwrCall
     */
    private $pwrcall;
    ...
    protected function setUp() {
        $this->pwrcall = new PwrCall(new WaitForUserRegState);
    }
//>>>> don't change the CUSTOM CODE comments, if you do generation will overwrite your code >>>>
//###START_CUSTOMCODE2
...
//###END_CUSTOMCODE2
     ...
     */
    public function testIsWaitForUserRegState() {
     ...
     * @covers WaitForUserRegState::cancel
     ...
     * @covers WaitForUserRegState::techProblem
     ...
     * @covers WaitForUserRegState::userRegistered
     * @uses   PwrCall::isWaitForUserParkedState
     */
     ...
     * @covers WaitForUserRegState::userRegFailed
     * @uses   PwrCall::isUserRegFailState
     */
     ...
     * @covers AbstractPwrCallState::stopCalling
     * @expectedException IllegalStateTransitionException
     */
