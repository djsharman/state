...
//###END_CUSTOMCODE2
     ...
     * @covers WaitForUserParkedState::cancel
     ...
     * @covers WaitForUserParkedState::techProblem
     ...
     * @covers WaitForUserParkedState::userParked
     * @uses   PwrCall::isUserParkedState
     */
     ...
     * @covers WaitForUserParkedState::userParkFailed
     * @uses   PwrCall::isUserParkFailState
     */
