...
class StartUpTest extends \PHPUnit_Framework_TestCase {
    ...
    protected function setUp() {
        $this->pwrcall = new PwrCall(new StartUpState);
    }
//>>>> don't change the CUSTOM CODE comments, if you do generation will overwrite your code >>>>
//###START_CUSTOMCODE2
...
//###END_CUSTOMCODE2
     ...
     * @covers StartUpState::reqRegState
     * @uses   PwrCall::isWaitForUserRegState
     */
     ...
     * @covers StartUpState::wpComplete
     * @uses   PwrCall::isWPCompleteState
     */
     ...
     * @covers StartUpState::techProblem
