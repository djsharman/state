...
//###END_CUSTOMCODE1
class UserParkedTest extends \PHPUnit_Framework_TestCase {
    /**
     * @var PwrCall
     */
    private $pwrcall;
    ...
    protected function setUp() {
        $this->pwrcall = new PwrCall(new UserParkedState);
    }
//>>>> don't change the CUSTOM CODE comments, if you do generation will overwrite your code >>>>
//###START_CUSTOMCODE2
...
//###END_CUSTOMCODE2
     ...
     * @covers UserParkedState::techProblem
     ...
     * @covers UserParkedState::startCalling
